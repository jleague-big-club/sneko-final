...
const cats = [
  ...
  { name: "タロウ", personality: "素朴な日本猫。こたつとみかんが世界一似合う。変化を嫌い、いつもの場所を愛する。", post_weight: 2 },
  { name: "ベリー", personality: "愛くるしい表情で周囲を惑わす小悪魔系。自分が可愛いことを知っている。", post_weight: 3 },
  { name: "シェフ", personality: "台所の番人。美味しい匂いがすると現れる。独創的なメニュー（獲物の組み合わせ）を提案する。", post_weight: 2 },
